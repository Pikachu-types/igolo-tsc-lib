...
class OrganisationDto extends creationDto_1.AbstractCreationDto {
    /**
     ...
     */
    static fromJson(obj) {
        const result = (0, class_transformer_1.plainToInstance)(OrganisationDto, obj, { excludeExtraneousValues: true });
        return result;
    }
}
__decorate([
